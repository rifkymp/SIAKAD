    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('pengaturan.ubah-foto') }}"  enctype="multipart/form-data" method="post">
        ...
        <div class="card-footer">
            <a href="{{ route("profile") }}" class="btn btn-info"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a> &nbsp;
            <button name="submit" class="btn btn-warning"><i class="nav-icon fas fa-upload"></i> &nbsp; Upload</button>
        </div>
      </form>
    </div>
    <!-- /.card -->
