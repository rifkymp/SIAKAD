    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('pengaturan.ubah-email') }}" method="post">
        ...
        <div class="card-footer">
          <a href="#" name="kembali" class="btn btn-info" id="back"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a> &nbsp;
          <button name="submit" class="btn btn-warning"><i class="nav-icon fas fa-save"></i> &nbsp; Update</button>
        </div>
      </form>
    </div>
    <!-- /.card -->
