...
<div class="card-body login-card-body">
  ...
  <form action="{{ route('cek-email') }}" method="post">
    ...
    <div class="row">
      <div class="col-6">
        <a href="{{ route('login') }}" class="text-center btn-block btn btn-light text-success">Login Saja</a>
      </div>
      <!-- /.col -->
      <div class="col-6">
        <a href="{{ route('register') }}" class="text-center btn-block btn btn-light text-success">Buat Akun</a>
      </div>
      <!-- /.col -->
    </div>
  </form>
