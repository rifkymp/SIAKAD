...
<div class="card-body login-card-body">
  ...
  <form action="{{ route('login') }}" method="post">
    ...
    <div class="row mb-1">
      ...
      <!-- /.col -->
      <div class="col-5">
        <button type="submit" id="btn-login"class="btn btn-success btn-block" disabled>{{ __('Login') }} &nbsp; <i class="nav-icon fas fa-sign-in-alt"></i></button>
      </div>
      <!-- /.col -->
    </div>
  </form>
  ...
  <p class="mb-0">
    <a class="text-success" href="{{ route('register') }}">Buat Akun Baru</a>
  </p>
</div>
@endsection
@section('script')
