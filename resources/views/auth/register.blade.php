...
<div class="card-body login-card-body">
  ...
  <form action="{{ route('register') }}" method="post">
    ...
    <div class="row mb-3">
      <div class="col-6">
        <a href="{{ route('login') }}" class="text-center btn btn-light text-success">Login Saja</a>
      </div>
      <!-- /.col -->
      <div class="col-6 justify-content-end">
        <button type="submit" class="btn btn-success btn-block">{{ __('Register') }} &nbsp; <i class="nav-icon fas fa-sign-in-alt"></i></button>
      </div>
      <!-- /.col -->
    </div>
  </form>
